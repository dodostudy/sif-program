...
const NAV_ITEMS = [
  ...
  { href: '/pages/risk-map.html', icon: 'map', label: '위험지도' },
  {
...
const ICONS = {
  ...
  trend: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 17l6-6 4 4 7-7"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 8h6v6"/></svg>`,
...
function renderSidebar() {
  ...
  themeToggle.className = 'no-print fixed top-3 right-3 z-50 theme-toggle-btn p-2 rounded-lg border transition-colors cursor-pointer';
  themeToggle.title = '다크/라이트 모드 전환';
